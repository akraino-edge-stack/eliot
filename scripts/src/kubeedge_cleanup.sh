...
rollback_k8smaster()
{
cd /etc/kubeedge/kubeedge/edge && sudo rm -rf edge_core edgecore
cd /etc/kubeedge/kubeedge/cloud && sudo rm -rf cloudcore
...
sshpass -p ${EDGENODEPASSWORD} ssh ${EDGENODEUSR}@${EDGENODEIP} ${UPGRADE1} < /dev/null
sshpass -p ${EDGENODEPASSWORD} ssh ${EDGENODEUSR}@${EDGENODEIP} ${INSTALL_IPVSADM} < /dev/null
sshpass -p ${EDGENODEPASSWORD} ssh ${EDGENODEUSR}@${EDGENODEIP} ${RESET_PORT} < /dev/null
sshpass -p ${EDGENODEPASSWORD} ssh ${EDGENODEUSR}@${EDGENODEIP} ${REMOVE_DOCKER1} < /dev/null
sshpass -p ${EDGENODEPASSWORD} ssh ${EDGENODEUSR}@${EDGENODEIP} ${REMOVE_DOCKER2} < /dev/null
sshpass -p ${EDGENODEPASSWORD} ssh ${EDGENODEUSR}@${EDGENODEIP} ${REMOVE_DOCKER3} < /dev/null
sshpass -p ${EDGENODEPASSWORD} ssh ${EDGENODEUSR}@${EDGENODEIP} ${REMOVE_DOCKER4} < /dev/null
sshpass -p ${EDGENODEPASSWORD} ssh ${EDGENODEUSR}@${EDGENODEIP} ${REMOVE_DOCKER5} < /dev/null
sshpass -p ${EDGENODEPASSWORD} ssh ${EDGENODEUSR}@${EDGENODEIP} ${REMOVE_DOCKER6} < /dev/null
sshpass -p ${EDGENODEPASSWORD} ssh ${EDGENODEUSR}@${EDGENODEIP} ${RESET_KUBEADM} < /dev/null
sshpass -p ${EDGENODEPASSWORD} ssh ${EDGENODEUSR}@${EDGENODEIP} ${REMOVE_KUBE_FILES1} < /dev/null
sshpass -p ${EDGENODEPASSWORD} ssh ${EDGENODEUSR}@${EDGENODEIP} ${REMOVE_KUBE_FILES2} < /dev/null
sshpass -p ${EDGENODEPASSWORD} ssh ${EDGENODEUSR}@${EDGENODEIP} ${REMOVE_KUBE_FILES3} < /dev/null
sshpass -p ${EDGENODEPASSWORD} ssh ${EDGENODEUSR}@${EDGENODEIP} ${REMOVE_KUBE_FILES4} < /dev/null
sshpass -p ${EDGENODEPASSWORD} ssh ${EDGENODEUSR}@${EDGENODEIP} ${REMOVE_KUBE_FILES5} < /dev/null
sshpass -p ${EDGENODEPASSWORD} ssh ${EDGENODEUSR}@${EDGENODEIP} ${REMOVE_KUBE_FILES6} < /dev/null
sshpass -p ${EDGENODEPASSWORD} ssh ${EDGENODEUSR}@${EDGENODEIP} ${AUTO_REMOVE} < /dev/null
sshpass -p ${EDGENODEPASSWORD} ssh ${EDGENODEUSR}@${EDGENODEIP} ${AUTO_CLEAN} < /dev/null
}
